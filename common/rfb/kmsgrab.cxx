...
#include <rfb/kmsgrab.h>
        ...
        LIBAVUTIL_VERSION_MAJOR == 56 && LIBAVUTIL_VERSION_MINOR > 55 || \
        LIBAVUTIL_VERSION_MAJOR == 56 && LIBAVUTIL_VERSION_MINOR == 55 && LIBAVUTIL_VERSION_MICRO >= 100
#define FFMPEG_PIX_FMT_RGB10_DEFINED
#endif
...
#ifdef FFMPEG_PIX_FMT_RGB10_DEFINED
    // 10-bit RGB.
